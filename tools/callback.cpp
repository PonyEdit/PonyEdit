...
void CallbackDummy::emitTriggerSuccess(QVariantMap result) { emit triggerSuccess(result); }
void CallbackDummy::emitTriggerFailure(QString error, int flags) { emit triggerFailure(error, flags); }
void CallbackDummy::emitTriggerProgress(int progress) { emit triggerProgress(progress); }
