...
// Json.h -- taken from https://raw.github.com/ereilin/qt-json
 ...
 */
		static QVariant parseValue( const QString &json,
		                            int &index,
		                            bool &success );
 ...
 */
		static QVariant parseObject( const QString &json,
		                             int &index,
		                             bool &success );
 ...
 */
		static QVariant parseArray( const QString &json,
		                            int &index,
		                            bool &success );
 ...
 */
		static QVariant parseString( const QString &json,
		                             int &index,
		                             bool &success );
