...
public:
	...
	OpenFileTreeView(OpenFileTreeView const&) = delete;
	OpenFileTreeView& operator=(OpenFileTreeView const&) = delete;
	...
	int refreshColumn() { return mRefreshColumn; }
	int closeColumn() { return mCloseColumn; }
