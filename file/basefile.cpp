...
void BaseFile::saveFailure( const QString &errorMessage, bool permissionError ) {
	...
	errorWidget->setButtons( StatusWidget::Retry | StatusWidget::Cancel | ( permissionError && mLocation.canSudo() && !mLocation.isSudo() ? StatusWidget::SudoRetry : StatusWidget::None ) );
