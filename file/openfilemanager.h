...
class OpenFileManager : public QObject {
	...
	public:
		...
		BaseFile* getFile( const Location& location ) const;    // Returns already-open files at specified
		                                                        // location,
		...
		bool closeFiles( const QList< BaseFile* >& files, bool force = false ); // Closes the list of files. If
		                                                                        // force
		                                                                        // unspecified or false, it
		                                                                        // confirms
