...
void AdvancedOptionsWidget::setTrace() { ui->loggingLevel->setValue(0); }
void AdvancedOptionsWidget::setDebug() { ui->loggingLevel->setValue(1); }
void AdvancedOptionsWidget::setInfo() { ui->loggingLevel->setValue(2); }
void AdvancedOptionsWidget::setWarn() { ui->loggingLevel->setValue(3); }
void AdvancedOptionsWidget::setError() { ui->loggingLevel->setValue(4); }
void AdvancedOptionsWidget::setFatal() { ui->loggingLevel->setValue(5); }
