...
SshHost::SshHost()
    : mDesiredStatus( Disconnected ), mFirstSlaveScriptChecker( 0 ), mSlaveScriptChecked( false ), mCachedIpAddress( 0 ), mCachedAuthMethod( SshSession::AuthNone ), mChannelLimitGuess( CHANNEL_LIMIT_GUESS ), mSaveHost( true ), mSavePassword( false ), mSaveKeyPassphrase( false ), mPort( 22 ) {
