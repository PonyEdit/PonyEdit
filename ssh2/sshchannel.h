...
public:
	...
	enum Type { Shell = 0x0001, Slave = 0x0002, Xfer = 0x0003, Sftp = 0x0004, Sudo = 0x8000, SudoSlave = Slave|Sudo, SudoXfer = Xfer|Sudo };
	...
	inline const QString& getErrorDetails() const { return mErrorDetails; }

	virtual void criticalError(const QString& error);

	virtual int getConnectionScore();	//	Returns a number indicative of how close to connected this channel is.
